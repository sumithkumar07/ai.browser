...
# app.include_router(hybrid_ai_router, prefix="/api/ai/hybrid", tags=["hybrid_ai"])  # temporarily commented out
...
# Include Phase 2-4 advanced routers - temporarily commented out to fix middleware issue
