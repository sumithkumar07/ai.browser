...
class AIBrowserAPITester:
    def __init__(self, base_url="https://ai-browser-boost.preview.emergentagent.com"):
    ...
    def run_hybrid_ai_backend_testing(self):
        ...
        print("Base URL: https://ai-browser-boost.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://ai-browser-boost.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://ai-browser-boost.preview.emergentagent.com")
