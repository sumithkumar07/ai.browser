...
class AIBrowserAPITester:
    ...
    def run_hybrid_ai_backend_testing(self):
        ...
        print("Base URL: https://issue-resolver-17.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://issue-resolver-17.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://issue-resolver-17.preview.emergentagent.com")
