...
class AIBrowserAPITester:
    def __init__(self, base_url="https://issue-resolver-16.preview.emergentagent.com"):
...
def main():
    ...
    print("Testing against: https://issue-resolver-16.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://issue-resolver-16.preview.emergentagent.com")
