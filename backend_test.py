...
class AIBrowserAPITester:
    def __init__(self, base_url="https://full-app-test.preview.emergentagent.com"):
    ...
    def run_comprehensive_all_phases_testing(self):
        ...
        print("Base URL: https://full-app-test.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://full-app-test.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://full-app-test.preview.emergentagent.com")
