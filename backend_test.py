...
class AIBrowserAPITester:
    def __init__(self, base_url="https://intellibrowse.preview.emergentagent.com"):
    ...
    def run_hybrid_ai_backend_testing(self):
        ...
        print("Base URL: https://intellibrowse.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://intellibrowse.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://intellibrowse.preview.emergentagent.com")
