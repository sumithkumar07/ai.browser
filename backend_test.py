...
class AIBrowserAPITester:
    def __init__(self, base_url="https://smart-browser-blend.preview.emergentagent.com"):
    ...
    def run_comprehensive_all_phases_testing(self):
        ...
        print("Base URL: https://smart-browser-blend.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://smart-browser-blend.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://smart-browser-blend.preview.emergentagent.com")
