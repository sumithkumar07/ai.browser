...
class AIBrowserAPITester:
    def __init__(self, base_url="https://web-ai-navigator.preview.emergentagent.com"):
    ...
    def run_hybrid_ai_backend_testing(self):
        ...
        print("Base URL: https://web-ai-navigator.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://web-ai-navigator.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://web-ai-navigator.preview.emergentagent.com")
