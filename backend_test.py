...
class AIBrowserAPITester:
    def __init__(self, base_url="https://quick-feature-fix.preview.emergentagent.com"):
    ...
    def run_hybrid_ai_backend_testing(self):
        ...
        print("Base URL: https://quick-feature-fix.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://quick-feature-fix.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://quick-feature-fix.preview.emergentagent.com")
