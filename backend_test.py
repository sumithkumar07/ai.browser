...
class AIBrowserAPITester:
    ...
    def run_hybrid_ai_backend_testing(self):
        ...
        print("Base URL: https://browser-agent-eval.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://browser-agent-eval.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://browser-agent-eval.preview.emergentagent.com")
