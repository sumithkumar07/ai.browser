...
class AIBrowserAPITester:
    def __init__(self, base_url="https://agentic-web-suite.preview.emergentagent.com"):
    ...
    def run_hybrid_ai_backend_testing(self):
        ...
        print("Base URL: https://agentic-web-suite.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://agentic-web-suite.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://agentic-web-suite.preview.emergentagent.com")
