...
class AIBrowserAPITester:
    def __init__(self, base_url="https://ux-verify-tool.preview.emergentagent.com"):
    ...
    def run_comprehensive_all_phases_testing(self):
        ...
        print("Base URL: https://ux-verify-tool.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://ux-verify-tool.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://ux-verify-tool.preview.emergentagent.com")
