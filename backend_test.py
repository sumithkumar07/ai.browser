...
class AIBrowserAPITester:
    def __init__(self, base_url="https://neon-fellou-test.preview.emergentagent.com"):
    ...
    def run_hybrid_ai_backend_testing(self):
        ...
        print("Base URL: https://neon-fellou-test.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://neon-fellou-test.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://neon-fellou-test.preview.emergentagent.com")
