...
def main():
    ...
    print("Testing against: https://minimal-ui-redesign.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://minimal-ui-redesign.preview.emergentagent.com")
