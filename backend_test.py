...
class AIBrowserAPITester:
    def __init__(self, base_url="https://e2e-testing-1.preview.emergentagent.com"):
    ...
    def run_hybrid_ai_backend_testing(self):
        ...
        print("Base URL: https://e2e-testing-1.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://e2e-testing-1.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://e2e-testing-1.preview.emergentagent.com")
