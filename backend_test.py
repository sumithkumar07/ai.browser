...
class AIBrowserAPITester:
    def __init__(self, base_url="https://seamless-ai-browser.preview.emergentagent.com"):
    ...
    def run_hybrid_ai_backend_testing(self):
        ...
        print("Base URL: https://seamless-ai-browser.preview.emergentagent.com")
        print("=" * 80)
...
def main():
    ...
    print("Testing against: https://seamless-ai-browser.preview.emergentagent.com")
    
    tester = AIBrowserAPITester("https://seamless-ai-browser.preview.emergentagent.com")
